...
- `core/codex_radar_client.py`: fetches HTML and the live software intelligence endpoint.
- `core/radar_display.py`: formats reset, quota, and IQ snapshots into compact Hermes text cards, with GPT score tables.
...
- `core/intelligence.py`: complete model discovery and GPT score normalization.
